...
\author{Kentaro Sato\\info@metaclan.jp\\[4pt]{\small DOI: \href{https://doi.org/10.5281/zenodo.19590278}{10.5281/zenodo.19590278}}\\[2pt]{\small \textcopyright{} 2026 Kentaro Sato. Paper: \href{https://creativecommons.org/licenses/by/4.0/}{CC BY 4.0}. Code: Apache 2.0.}}
\date{April 15, 2026}
...
We evaluate nsep+pchan4 across all 12 Pre-LN models from the Arc paper test suite \citep{sato2026arc}, spanning 4 architecture families (GPT, Pythia, OPT, Qwen/Mistral, Falcon), both MHA and GQA attention, and three orders of magnitude in parameter count (Table~\ref{tab:sweep}).
